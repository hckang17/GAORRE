...
void showEditCategoryModal(BuildContext context, String? menuCategoryKey, String? menuCategoryValue, Map<String, String?> currentMenuCategory) {
...
class EditCategoryModal extends ConsumerWidget {
  ...
  EditCategoryModal({this.menuCategoryKey, this.menuCategoryValue, required this.currentMenuCategory})
